...
namespace EndlessSisyphus
{
    ...
    public sealed class QuoteDirector : MonoBehaviour
    {
        ...
        {
            new QuoteCue("Если этот миф трагичен, то лишь потому, что его герой наделен сознанием", 10f),
            ...
            new QuoteCue("Камень – его достояние. Равно как и абсурдная вселенная, в которой он живет", 15f),
            ...
            new QuoteCue("Нет кары более ужасной, чем бесполезный и безнадежный труд", 10f),
